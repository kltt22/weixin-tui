...
<html>
<head>
<meta http-equiv="Content-Type" charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge">
...
if($row['ifweizhi']==0){
?>
         <div class="topad" id="topad" style="display:block"><a href="ad.php?id=<?=$row['id']?>"><img src="<?=$row['adpic']?>" style="width:100%;max-height:100px;" ></a><?php echo $telnum;?>
         </div>
         <?php } ?>
		<div id="page-content">
			<div id="img-content">
                ...
                <div style="text-align:center; margin-top:50px;"><img src="<?=$row['qrcode']?>" border="0" /></div>
				<a name="weixin"></a>
			</div>
		</div>
	</div>
