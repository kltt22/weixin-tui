...
<div class="padding:0px;">
	...
	<form action="?act=login" id="signupok" method="post">
		...
		<dl class="clearfix">
			<dd>账号：</dd>
			<dd><input name="userid" type="text" class="input_txt" id="userid" placeholder="请输入用户名(test)" value=""></dd>
		</dl>
		<dl class="clearfix">
			<dd>密码：</dd>
			<dd><input type="password" class="input_txt" id="userpwd" value="" name="userpwd" placeholder="请输入密码(test)"></dd>
		</dl>
		<div class="btn_box">
